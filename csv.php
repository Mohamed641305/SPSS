...
<body>
  ...
  <div class="container py-4">
    ...
    <div class="row mt-3 g-3">
      ...
      <div class="col-md-3">
        <div class="card-box c-low">🟢 Low <h3><?= $low ?></h3>
        </div>
      </div>
      <div class="col-md-3">
        <div class="card-box c-medium">🟡 Medium <h3><?= $medium ?></h3>
        </div>
      </div>
      <div class="col-md-3">
        <div class="card-box c-high">🟠 High <h3><?= $high ?></h3>
        </div>
      </div>
      <div class="col-md-3">
        <div class="card-box c-critical">🔴 Critical <h3><?= $critical ?></h3>
        </div>
      </div>
