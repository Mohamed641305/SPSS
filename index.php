...
<h2>🏥 Medical SPSS PRO – AI Analytics Dashboard</h2>
...
Total Patients<br><h4><?=count($rows)?></h4>
</div>

<div class="col-md-3 card stat">
Avg BMI<br><h4><?=round(mean($data['bmi']??[]),2)?></h4>
</div>

<div class="col-md-3 card stat">
Std BMI<br><h4><?=round(std($data['bmi']??[]),2)?></h4>
</div>

<div class="col-md-3 card stat">
Correlation<br><h4><?=round(correlation($data['blood_pressure']??[], $data['sugar_level']??[]),2)?></h4>
</div>
